...
FLOOD_ZONES: dict[str, dict] = {
    ...
    # ── Asia cities ──
    "GLOBAL.IND_GANGES_CITY": {"risk": 5, "name": "India Ganges Region", "source": "Global Flood Hazard Map 2023, IMD"},
    "GLOBAL.IND_MUMBAI": {"risk": 4, "name": "India Mumbai", "source": "Global Flood Hazard Map 2023, IMD"},
    "GLOBAL.CHN_SHANGHAI": {"risk": 4, "name": "China Shanghai", "source": "Global Flood Hazard Map 2023, CMA"},
    "GLOBAL.CHN_GUANGDONG": {"risk": 4, "name": "China Guangdong/Pearl Delta", "source": "Global Flood Hazard Map 2023, CMA"},
    "GLOBAL.JPN_TOKYO": {"risk": 3, "name": "Japan Tokyo", "source": "Global Flood Hazard Map 2023, JMA"},
    "GLOBAL.JPN_OSAKA": {"risk": 3, "name": "Japan Osaka", "source": "Global Flood Hazard Map 2023, JMA"},
    "GLOBAL.KOR_SEOUL": {"risk": 3, "name": "South Korea Seoul", "source": "Global Flood Hazard Map 2023, KMA"},
    "GLOBAL.IDN_JAKARTA": {"risk": 5, "name": "Indonesia Jakarta", "source": "Global Flood Hazard Map 2023, BMKG"},
    "GLOBAL.IDN_SUMATRA": {"risk": 4, "name": "Indonesia Sumatra", "source": "Global Flood Hazard Map 2023, BMKG"},
    "GLOBAL.PHL_MANILA_CITY": {"risk": 5, "name": "Philippines Manila", "source": "Global Flood Hazard Map 2023, PAGASA"},
    "GLOBAL.VNM_HCMC": {"risk": 4, "name": "Vietnam Ho Chi Minh City", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.THA_BANGKOK": {"risk": 4, "name": "Thailand Bangkok", "source": "Global Flood Hazard Map 2023, TMD"},
    "GLOBAL.MYS_KUALA_LUMPUR": {"risk": 3, "name": "Malaysia Kuala Lumpur", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.BGD_DHAKA": {"risk": 5, "name": "Bangladesh Dhaka", "source": "Global Flood Hazard Map 2023, extreme"},
    "GLOBAL.BGD_CHITTAGONG": {"risk": 5, "name": "Bangladesh Chittagong", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.PAK_KARACHI": {"risk": 3, "name": "Pakistan Karachi", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.LKA_COLOMBO": {"risk": 3, "name": "Sri Lanka Colombo", "source": "Global Flood Hazard Map 2023"},
    # ── Africa cities ──
    "GLOBAL.NGA_LAGOS_CITY": {"risk": 3, "name": "Nigeria Lagos", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.NGA_DELTA": {"risk": 4, "name": "Nigeria Niger Delta", "source": "Global Flood Hazard Map 2023, NIMET"},
    "GLOBAL.EGY_NILE_DELTA": {"risk": 3, "name": "Egypt Nile Delta", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.ZAF_CAPE_TOWN": {"risk": 2, "name": "South Africa Cape Town", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.ZAF_DURBAN": {"risk": 3, "name": "South Africa Durban", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.KEN_MOMBASA": {"risk": 3, "name": "Kenya Mombasa", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.TZA_DAR_ES_SALAAM": {"risk": 3, "name": "Tanzania Dar es Salaam", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.MOZ_MAPUTO": {"risk": 3, "name": "Mozambique Maputo", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.GHA_ACCRA": {"risk": 3, "name": "Ghana Accra", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.CMR_DOUALA": {"risk": 4, "name": "Cameroon Douala", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.SEN_DAKAR": {"risk": 2, "name": "Senegal Dakar", "source": "Global Flood Hazard Map 2023"},
    # ── South America cities ──
    "GLOBAL.BRA_SAO_PAULO": {"risk": 3, "name": "Brazil São Paulo", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.BRA_RIO": {"risk": 4, "name": "Brazil Rio de Janeiro", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.BRA_BELEM": {"risk": 4, "name": "Brazil Belém", "source": "Global Flood Hazard Map 2023, Amazon delta"},
    "GLOBAL.BRA_RECIFE": {"risk": 3, "name": "Brazil Recife", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.ARG_BUENOS_AIRES": {"risk": 3, "name": "Argentina Buenos Aires", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.PER_LIMA": {"risk": 2, "name": "Peru Lima", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.COL_BOGOTA": {"risk": 3, "name": "Colombia Bogotá", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.COL_CARTAGENA": {"risk": 3, "name": "Colombia Cartagena", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.CHL_SANTIAGO": {"risk": 2, "name": "Chile Santiago", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.ECU_GUAYAQUIL": {"risk": 3, "name": "Ecuador Guayaquil", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.VEN_CARACAS": {"risk": 3, "name": "Venezuela Caracas", "source": "Global Flood Hazard Map 2023"},
    # ── North America cities ──
    "GLOBAL.USA_MIAMI": {"risk": 4, "name": "USA Miami", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_HOUSTON": {"risk": 4, "name": "USA Houston", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_NEW_ORLEANS": {"risk": 5, "name": "USA New Orleans", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_NEW_YORK": {"risk": 3, "name": "USA New York", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_BOSTON": {"risk": 3, "name": "USA Boston", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_LOS_ANGELES": {"risk": 2, "name": "USA Los Angeles", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_SAN_FRANCISCO": {"risk": 2, "name": "USA San Francisco", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.USA_SEATTLE": {"risk": 2, "name": "USA Seattle", "source": "Global Flood Hazard Map 2023, NOAA"},
    "GLOBAL.CAN_VANCOUVER": {"risk": 2, "name": "Canada Vancouver", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.CAN_TORONTO": {"risk": 2, "name": "Canada Toronto", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.CAN_MONTREAL": {"risk": 2, "name": "Canada Montreal", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.MEX_CANCUN": {"risk": 3, "name": "Mexico Cancún", "source": "Global Flood Hazard Map 2023"},
    "GLOBAL.MEX_CDMX": {"risk": 2, "name": "Mexico Mexico City", "source": "Global Flood Hazard Map 2023"},
    # ── Oceania cities ──
    "GLOBAL.AUS_SYDNEY": {"risk": 2, "name": "Australia Sydney", "source": "Global Flood Hazard Map 2023, BoM"},
    "GLOBAL.AUS_BRISBANE": {"risk": 3, "name": "Australia Brisbane", "source": "Global Flood Hazard Map 2023, BoM"},
    "GLOBAL.AUS_CAIRNS": {"risk": 4, "name": "Australia Cairns", "source": "Global Flood Hazard Map 2023, BoM"},
    "GLOBAL.AUS_DARWIN": {"risk": 4, "name": "Australia Darwin", "source": "Global Flood Hazard Map 2023, BoM"},
    "GLOBAL.AUS_PERTH": {"risk": 2, "name": "Australia Perth", "source": "Global Flood Hazard Map 2023, BoM"},
    "GLOBAL.NZL_AUCKLAND": {"risk": 2, "name": "New Zealand Auckland", "source": "Global Flood Hazard Map 2023, NIWA"},
    "GLOBAL.NZL_WELLINGTON": {"risk": 2, "name": "New Zealand Wellington", "source": "Global Flood Hazard Map 2023, NIWA"},
    "GLOBAL.FJI_SUVA": {"risk": 3, "name": "Fiji Suva", "source": "Global Flood Hazard Map 2023"},
}
